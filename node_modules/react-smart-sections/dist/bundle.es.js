  ...
  createClass(Section, [{
    ...
    value: function render() {
      ...
      if (typeof component === 'string') {
        return React.createElement(component, _extends({ children: children }, restProps));
      }
      if (component) {
        return React.createElement(component, _extends({ children: children, render: render }, restProps));
      }
...
export { Section, SectionSpy, SectionsSpy };
